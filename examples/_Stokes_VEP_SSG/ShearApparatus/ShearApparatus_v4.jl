...
@views function main(nc, θgouge)
    ...
    materials.n .= [1.0, 1.0, 1.0, 1.0]
    materials.η0 .= [1e48, 1e28, 1e19, 1e48] ./ sc.σ ./ sc.t
    materials.G .= [1e10, 1e9, 1e60, 1e10] ./ sc.σ
    materials.plasticity.C .= [2e8, 1e6, 15e60, 15e60] ./ sc.σ
    materials.plasticity.ϕ .= [35.0, 30.0, 35.0, 35.0]
    materials.plasticity.ψ .= [0.0, 5.0, 0.0, 0.0]
    materials.plasticity.ηvp .= [1e14, 1e14, 1e14, 1e14] .* 1e-6 ./ sc.σ ./ sc.t
    materials.β .= [1e-11, 1e-10, 1e-12, 1e-12] .* sc.σ
    ...
    for it = 1:nt
        ...
        function figure()
            ...
            scatter!(ax, P_rock * sc.σ / 1e6, (τII_rock .- λ̇_rock .* materials.plasticity.ηvp[2]) * sc.σ / 1e6, color=:black)
